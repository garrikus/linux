...
MODULE_AUTHOR("Igor Korolyuk <garrikus@mail.ru>");
MODULE_DESCRIPTION("A custome driver derived from Generic DSI Command Mode Panel Driver");
MODULE_LICENSE("GPL");
